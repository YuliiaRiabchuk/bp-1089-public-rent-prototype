 ...
 *
 * ⚠️ ЗАГЛУШКА ПО АССЕТУ. Все марки в `public/brand/` — `logo-wordmark`,
 * `logo-mark`, `logo-lockup` — несут суффикс «CRM»: это айдентика внутренней
 * системы, а не компании. Клиент арендует инструмент у «Будпрокату», и слово
 * CRM в SMS-ссылке ему ничего не говорит и работает против доверия. Пока
